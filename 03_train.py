...
Or:
    python3 scripts/03_train.py --data dataset/data.yaml --model yolov8n.pt --epochs 100 --patience 20 --imgsz 640 --batch 8 --name water_meter_corrected_names
"""
...
def parse_args():
    ...
    parser.add_argument("--patience", type=int, default=0, help="Early stopping patience epochs (0 to disable)")
...
def main() -> None:
    ...
    # If patience is 0, Ultralytics ignores it or uses defaults. 
    # Passing the parsed argument directly to the trainer.
    model.train(
        data=str(data_yaml),
        epochs=args.epochs,
